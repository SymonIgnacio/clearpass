...
async function setupSimpleDatabase() {
  ...
  try {
    console.log('🚀 Setting up BMWs Database (Simple)...');
    ...
    console.log('✅ Database bmw_barangay_batia created');
    ...
    // Execute the tables and data one by one to avoid SQL syntax issues
    ...
    const insertStatements = [
      // Insert sitios
      `INSERT IGNORE INTO sitios (name, description) VALUES
      ...
      // Insert officials
      `INSERT IGNORE INTO officials (name, position, role_access_level, contact_number, email) VALUES
      ...
      // Insert users
      `INSERT IGNORE INTO users (username, password_hash, role, email, full_name, official_id) VALUES
      ('captain', '$2b$10$8K3VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ', 'captain', 'captain@barangay-batia.gov.ph', 'Juan Dela Cruz', 1),
      ('secretary', '$2b$10$8K3VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ', 'secretary', 'secretary@barangay-batia.gov.ph', 'Maria Santos', 2),
      ('clerk', '$2b$10$8K3VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ8VzJcXH9pZ', 'clerk', 'clerk@barangay-batia.gov.ph', 'Pedro Reyes', 3)`,
      ...
      `INSERT IGNORE INTO certificates_log (
    ...
    const [blotter] = await connection.execute('SELECT COUNT(*) as count FROM blotter');
    const [certificates] = await connection.execute('SELECT COUNT(*) as count FROM certificates_log');

    console.log('\n📊 Sample data loaded:');
    console.log(`  • Residents: ${residents[0].count}`);
    console.log(`  • Blotter cases: ${blotter[0].count}`);
