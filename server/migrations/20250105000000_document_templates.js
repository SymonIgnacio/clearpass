      ...
      return knex('document_templates').insert([
        ...
        },
        {
          ...
          template_content: JSON.stringify({
            ...
            header_text: 'TO WHOM IT MAY CONCERN:',
            main_content:
              'This is to certify that {resident_name}, {age} years old, is a bona fide resident of {address}.',
            additional_content:
              'This further certifies that the above-named person has been residing in this barangay for {years_of_residency}.',
            footer_text:
