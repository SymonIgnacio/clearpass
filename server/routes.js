...
router.post('/admin/users',
    verifyToken, verifyRole([ROLES.ADMIN]), (req, res) => { res.status(501).json({ message: 'User creation via API coming soon - use database directly' }); });
router.put('/admin/users/:id',
    verifyToken, verifyRole([ROLES.ADMIN]), (req, res) => { res.status(501).json({ message: 'User update via API coming soon' }); });
router.get('/admin/settings',
    verifyToken, verifyRole([5]), asyncHandler(async (req, res) => {
    res.json({
...
router.get('/admin/reports/pdf/blotter',
    verifyToken, (req, res) => { res.json({ message: 'Blotter PDF report temporarily disabled' }); });
router.get('/admin/reports/pdf/residents',
    verifyToken, (req, res) => { res.json({ message: 'Residents PDF report temporarily disabled' }); });
...
router.post('/clerk/residents',
    verifyToken, verifyRole([ROLES.CLERK]), (req, res) => { res.status(501).json({ message: 'Use /api/residents endpoint instead' }); });
router.post('/clerk/clearances/issue',
    verifyToken, verifyRole([ROLES.CLERK]), (req, res) => { res.status(501).json({ message: 'Use /api/certificates endpoint instead' }); }); // The Logic Gate Endpoint
router.get('/clerk/documents',
    verifyToken, verifyRole([ROLES.CLERK]), (req, res) => { res.status(501).json({ message: 'Use /api/documents/requests endpoint instead' }); });
...
router.get('/officer/ai-analytics',
    verifyToken, verifyRole([ROLES.BLOTTER_OFFICER]), (req, res) => { res.status(501).json({ message: 'AI analytics feature coming soon' }); });
router.get('/officer/reports',
    verifyToken, verifyRole([ROLES.BLOTTER_OFFICER]), (req, res) => { res.status(501).json({ message: 'Reports feature coming soon' }); });

// =========================================================================
// ROLE 4: RESIDENT ROUTES (Self-Service)
// =========================================================================
router.get('/resident/dashboard',
    verifyToken, verifyRole([ROLES.RESIDENT]), asyncHandler(async (req, res) => {
...
router.post('/resident/request-clearance',
    verifyToken, verifyRole([ROLES.RESIDENT]), (req, res) => { res.status(501).json({ message: 'Use /api/certificates endpoint instead' }); });
router.get('/resident/requests',
    verifyToken, verifyRole([ROLES.RESIDENT]), (req, res) => { res.status(501).json({ message: 'Use /api/certificates endpoint instead' }); });
router.get('/resident/profile',
    verifyToken, verifyRole([ROLES.RESIDENT]), (req, res) => { res.status(501).json({ message: 'Use /api/auth/profile endpoint instead' }); });
router.post('/resident/profile/update-photo',
    verifyToken, verifyRole([ROLES.RESIDENT]), upload.single('photo'), (req, res) => { res.status(501).json({ message: 'Photo upload feature coming soon' }); });
router.post('/resident/upload-verification',
    verifyToken, verifyRole([ROLES.RESIDENT]), verificationUpload.single('verification'), (req, res) => { res.status(501).json({ message: 'Verification upload feature coming soon' }); });

// =========================================================================
// ROLE 5: CAPTAIN ROUTES (Read-Only Executive)
// =========================================================================
router.get('/captain/dashboard',
    verifyToken, verifyRole([ROLES.CAPTAIN]), asyncHandler(async (req, res) => {
    const [residents] = await db.execute('SELECT COUNT(*) as total FROM residents WHERE Residency_Status = "Active"');
    const [blotter] = await db.execute('SELECT COUNT(*) as total FROM blotter WHERE Status IN ("Pending", "Ongoing")');
...
router.post('/ai/chatbot/message',
    verifyToken, validateChatbotMessage, asyncHandler(async (req, res) => {
...
router.get('/households',
    verifyToken, verifyRole([1, 2, 5, 6]), asyncHandler(async (req, res) => {
...
router.get('/sitios',
    verifyToken, verifyRole([1, 2, 3, 5, 6]), asyncHandler(async (req, res) => {
...
router.post('/blotter',
    verifyToken, verifyRole([ROLES.ADMIN, ROLES.BLOTTER_OFFICER]), validateBlotter, asyncHandler(async (req, res) => {
...
router.delete('/blotter/:id',
    verifyToken, verifyRole([ROLES.ADMIN, ROLES.BLOTTER_OFFICER]), asyncHandler(async (req, res) => {
...
router.get('/census',
    verifyToken, verifyRole([ROLES.CAPTAIN, ROLES.SECRETARY, ROLES.CLERK, ROLES.ADMIN]), asyncHandler(async (req, res) => {
...
router.post('/residents',
    verifyToken, verifyRole([ROLES.ADMIN, ROLES.CAPTAIN]), validateResident, asyncHandler(async (req, res) => {
...
router.put('/residents/:id',
    verifyToken, verifyRole([ROLES.ADMIN, ROLES.CAPTAIN]), asyncHandler(async (req, res) => {
    const { id } = req.params;
