...
module.exports = db => {
  ...
  router.get(
    '/',
    verifyToken,
    checkRole(['admin', 'captain', 'secretary', 'clerk', 'blotter_officer']),
    asyncHandler(blotterController.getAll)
  );
  ...
  router.post(
    '/',
    verifyToken,
    checkRole(['admin', 'blotter_officer']),
  ...
  router.put(
    ...
    verifyToken,
    checkRole(['admin', 'blotter_officer']),
    asyncHandler(blotterController.update)
  );
  ...
  router.delete(
    ...
    asyncHandler(blotterController.delete)
  );
