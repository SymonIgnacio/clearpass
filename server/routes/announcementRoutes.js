...
module.exports = (db) => {
  ...
  router.put('/:id', verifyToken, checkRole(['admin', 'secretary']), asyncHandler(async (req, res) => {
  ...
  // DELETE announcement
  router.delete('/:id', verifyToken, checkRole(['admin', 'secretary']), asyncHandler(async (req, res) => {
