...
// Set persistence to local storage and handle auth state
...
auth.onAuthStateChanged(async (user) => {
  if (user) {
    try {
      ...
      console.warn('Invalid Firebase session, signing out:', error)
      // If token is invalid, sign out to clean up the session
