...
const OfficerNewCase = () => {
  ...
  const incidentTypes = [
    'Noise Complaint', 'Property Dispute', 'Domestic Violence',
    'Theft', 'Assault', 'Vandalism', 'Public Disturbance', 'Other'
  ];
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" gutterBottom>New Case Encoding</Typography>
      ...
      <Paper sx={{ p: 3 }}>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom>Complainant Information</Typography>
            </Grid>
            ...
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom>Respondent Information</Typography>
            </Grid>
            <Grid item xs={12} md={4}>
              <TextField
                fullWidth
