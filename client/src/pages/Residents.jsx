            ...
            <Grid container spacing={2}>
              ...
              <Grid xs={12} sm={6} md={3}>
                <FormControl fullWidth>
                  ...
                  >
                    ...
                    {sitios.map((sitio) => (
                      <MenuItem key={sitio.id} value={sitio.name}>{sitio.name}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
              </Grid>
              ...
              <Grid xs={12} sm={6} md={3}>
                <FormControl fullWidth>
                  ...
                  >
                    <MenuItem value="">All</MenuItem>
                    <MenuItem value="vulnerable">Any Vulnerability</MenuItem>
                    <MenuItem value="senior">Senior Citizens</MenuItem>
                    <MenuItem value="pwd">PWD</MenuItem>
                    <MenuItem value="4ps">4Ps Members</MenuItem>
                    <MenuItem value="solo_parent">Solo Parents</MenuItem>
                    <MenuItem value="osy">Out of School Youth</MenuItem>
                  </Select>
                </FormControl>
              </Grid>
            </Grid>
