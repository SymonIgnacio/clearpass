...
const QRCodeModal = ({ open, onClose, qrCode, residentName }) => {
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ p: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" align="center">
          This QR code uniquely identifies the resident and can be used for attendance, 
          document requests, and verification purposes.
        </Typography>
      </DialogContent>
