    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 404) {
          ...
          throw new Error('Authentication failed. Please try logging out and signing up again.')
      ...
      if (err.message.includes('fetch')) {
        ...
        setError(err.message || 'Account created but verification failed. Please contact support.')
      }
    }
  }
