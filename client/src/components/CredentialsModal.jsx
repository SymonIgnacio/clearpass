      ...
      <DialogContent sx={{ p: 3 }}>
        ...
        <Paper variant="outlined" sx={{ p: 3, bgcolor: 'grey.50', mb: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="h6" sx={{ fontFamily: 'monospace', color: 'primary.main', fontWeight: 'bold' }}>
        ...
        <Alert severity="warning" sx={{ mb: 2 }}>
          <Typography variant="body2">
            <strong>Important:</strong> Provide these credentials to the resident securely. They will need the email and temporary password for their first login.
          </Typography>
        </Alert>

        <Typography variant="body2" color="text.secondary" align="center">
          The temporary password is only valid until the first login, where they will be prompted to change it.
        </Typography>
      </DialogContent>
